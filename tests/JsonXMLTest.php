...
{
    public function testUsingXML1(): void
    {
...
EOT;
    ...
    public function testUsingXML2(): void
    {
        $xmlStringContents = <<<EOT
<?xml version="1.0" encoding="UTF-8"?>
<books>
...
EOT;
    ...
    public function testUsingXML3(): void
    {
        $xmlStringContents = <<<EOT
...
EOT;
    ...
    public function testUsingXML4(): void
    {
        $xmlStringContents = <<<EOT
<?xml version="1.0" encoding="UTF-8"?>
<PurchaseRequisition>
...
EOT;
    ...
    public function testUsingXML5(): void
    {
        $xmlStringContents = <<<EOT
<?xml version="1.0"?>
<tvshows>
...
EOT;
    ...
    public function testUsingXML6(): void
    {
        $xmlStringContents = <<<EOT
<?xml version="1.0"?>
<demo>
...
EOT;
    ...
    public function testUsingXML7(): void
    {
        $xmlStringContents = <<<EOT
...
EOT;
    ...
    public function testUsingXML8(): void
    {
        $xmlStringContents = <<<EOT
<?xml version="1.0"?>
<a><b id="foo" />bar</a>
...
EOT;
     ...
     */
    public function testNestingDepthIsHandledProperlyWhenNestingDepthExceedsMaximum(string $xmlStringContents): void
    {
     ...
     * @dataProvider providerNestingDepthIsHandledProperly
     */
    public function testNestingDepthIsHandledProperlyWhenNestingDepthDoesNotExceedMaximum(string $xmlStringContents): void
    {
        try {
